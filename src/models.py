...
#   timestamp: 2025-08-08T10:18:16+00:00
...
class ReadLiveOrdersRequest(BaseModel):
    start: Annotated[
        Optional[int],
        Field(
            description='Starting index of the orders to be fetched. Required if end > 1,000.',
            examples=[0],
        ),
    ] = None
    end: Annotated[
        int,
        Field(
            description='Last index of the orders to be fetched. Note that end - start must be less than 1,000.',
            examples=[100],
        ),
    ]
    projectId: Annotated[
...
class BacktestSummaryResult(BaseModel):
    ...
    status: Annotated[
        Optional[Status1], Field(description='Status of the backtest.')
    ] = None
    name: Annotated[Optional[str], Field(description='Name of the backtest.')] = None
    created: Annotated[
        Optional[datetime], Field(description='Backtest creation date and time.')
